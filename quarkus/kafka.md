...
https://redpanda.com/blog/web-user-interface-tools-kafka
...
https://github.com/muzir/softwareLabs/blob/master/spring-boot-kafka-cluster/docker/kafka/docker-compose.yml
...
https://smallrye.io/smallrye-reactive-messaging/4.11.0/kafka/test-companion/
